...
return {src = "https://codeberg.org/comfysage/artio.nvim", dependencies = "nvim-mini/mini.icons", opts = {opts = {marker = "*", bottom = false, shrink = false}, mappings = {["<C-j>"] = "down", ["<C-n>"] = "down", ["<C-k>"] = "up", ["<C-p>"] = "up", ["<Enter>"] = "accept", ["<Tab>"] = "accept", ["<C-m>"] = "mark", ["<Esc>"] = "cancel", ["<C-g>"] = "togglelive", ["<C-l>"] = "togglepreview", ["<C-s>"] = "split", ["<C-v>"] = "vsplit", ["<C-t>"] = "tabnew"}}, config = _2_, enabled = false}
