...
vim.keymap.set("n", mod("n"), _2_, {silent = true, desc = "spawn new instance"})
local function _4_()
  return vim.api.nvim_paste(vim.fn.getreg("+"), true, -1)
end
return vim.keymap.set({"n", "v", "s", "x", "o", "i", "l", "c", "t"}, mod("v"), _4_, {silent = true, desc = "paste from system clipboard"})
