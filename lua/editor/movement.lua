-- [nfnl] fnl/editor/movement.fnl
local _local_1_ = require("lib.nvim")
local hi = _local_1_.hi
vim.pack.add({"https://github.com/tpope/vim-repeat", "https://codeberg.org/andyg/leap.nvim", "https://github.com/nvim-mini/mini.jump", "https://github.com/nvim-mini/mini.surround", "https://github.com/kawre/neotab.nvim"})
...
return require("neotab").setup(opts)
